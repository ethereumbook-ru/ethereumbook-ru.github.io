...
|-----------|-------------------|
| [EIP-1](http://bit.ly/2OVq6qa) | Цель и руководящие принципы EIP |
| [EIP-2](http://bit.ly/2yJtTNa) | Изменения, связанные с хард-форком |
| [EIP-5](http://bit.ly/2Jrx93V) | Gas Usage for `RETURN` and `CALL*` |
| [EIP-6](http://bit.ly/2OYbc2t) | Renaming +SUICIDE+ Opcode |
| [EIP-7](http://bit.ly/2JxdBeN) | `DELEGATECALL` |
| [EIP-8](http://bit.ly/2Q6Oly6) | devp2p Forward Compatibility Requirements for Homestead |
...
| [EIP-55](http://bit.ly/2Q6R4YB)| Кодирование адреса контрольной суммы в смешанном регистре | 
...
|[EIP-100](http://bit.ly/2AC05DM) | Изменить настройку сложности на целевое среднее время блока и включение дядек. |
...
|[EIP-105](http://bit.ly/2Q5sdEv) | Бинарный шардинг плюс семантика вызова контрактов. "Лесенка для шардинга" EIP, позволяющая распараллеливать транзакции Ethereum с помощью механизма шардинга двоичного дерева и создающая основу для последующей схемы шардинга. Исследования в процессе; см. https://github.com/ethereum/sharding[]. |
|[EIP-137](http://bit.ly/2yG2Dzi) | Служба доменных имен Ethereum - спецификация | 
...
|[EIP-141](http://bit.ly/2CQMXfe) | Designated invalid EVM instruction |
|[EIP-145](http://bit.ly/2qhKz9Y) | Инструкции побитового сдвига в EVM |
|[EIP-150](http://bit.ly/2qhxflQ) | Изменение стоимости газа для операций с большим объемом ввода-вывода |
|[EIP-155](http://bit.ly/2CQUgne) | Простая защита от атаки повторного воспроизведения. Атака повторного воспроизведения позволяет любой транзакции, использующей узел или клиент Ethereum до EIP-155, стать подписанной, чтобы она была действительной и выполнялась как в цепочке Ethereum, так и в Ethereum Classic. |
|[EIP-158](http://bit.ly/2JryBmT) | Государственный клиринг |
|[EIP-160](http://bit.ly/2CR6VGY) | Увеличение стоимости EXP | 
|[EIP-161](http://bit.ly/2OfU96M) | Расчистка тройки штатов (инвариантно-сохраняющая альтернатива) |
|[EIP-162](http://bit.ly/2JxdKil)| Начальный регистратор хэша ENS |
|[EIP-165](http://bit.ly/2OgsOkO) | Обнаружение стандартного интерфейса ERC-165 |
|[EIP-170](http://bit.ly/2OgCWu1) | Ограничение размера кода контракта |
|[EIP-181](http://bit.ly/2ERNv7g)| Поддержка ENS для обратного разрешения адресов Ethereum | 
|[EIP-190](http://bit.ly/2P0wPz5)| Стандарт упаковки смарт-контрактов Ethereum |
...
|[EIP-225](http://bit.ly/2JssHlJ) | Rinkeby testnet, использующий доказательство полномочий, где блоки добываются только доверенными подписчиками. |
|[EIP-234](http://bit.ly/2yPBavd)| Добавить `blockHash` в опции фильтра JSON-RPC |
|[EIP-615](http://bit.ly/2yKrBNM) | Подпрограммы и статические переходы для EVM |
|[EIP-616](http://bit.ly/2AzGX99) | SIMD-операции для EVM |
|[EIP-681](http://bit.ly/2qjYX1n) | Формат URL для транзакционных запросов |
|[EIP-649](http://bit.ly/2OYgE5n) | Metropolis Задержка бомбы сложности и уменьшение награды за блок. Задержка Ледникового периода (он же Бомба сложности) на 1 год и снижение награды за блок с 5 до 3 эфиров. |
...
|[EIP-706](http://bit.ly/2Ogwpzs) | DEVp2p snappy compression |
...
| [EIP-758](http://bit.ly/2qmuDmJ) | Подписки и фильтры для завершенных транзакций |
| [EIP-801](http://bit.ly/2RnqlHy) | ERC-801 Canary Standard |
